...
<body class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 flex flex-wrap justify-center items-start">
        <div class="w-full md:w-1/2 lg:w-1/3 pr-4 mt-8">
            ...
            <?php if ($totalProduct > 0) { ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <?php while ($data = mysqli_fetch_array($result)) { ?>
                        <div class="bg-gray-100 rounded-lg overflow-hidden shadow-md cursor-pointer">
                            <img src="image/<?php echo $data['image'] ?>" alt="Product Image" class="w-full h-auto object-cover">
                            <div class="p-4">
