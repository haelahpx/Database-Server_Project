...
if(isset($_GET['id'])) {
    ...
    // Redirect or display an error message if 'id' is not set
    ...
    <div class="w-full md:w-1/2 bg-white rounded-lg shadow-md p-8">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button name="deleteBtn" type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-6 rounded">Delete</button>
