    ...
    <div class="mx-auto max-w-7xl py-8 px-4 sm:px-6 lg:pt-14 lg:px-14">
        <div class="flex h-full w-full flex-col justify-between lg:flex-row md:justify-center md:space-x-10">
            <div class="w-full space-y-4 xl:col-span-1">
                ...
                <p class="text-base" style="color:#ffffff">Top Up Game Favorit Kamu Di Xcashshop Agar Main Game Semakin Seru. Pengiriman Cepat Dan Berbagai Macam Game Populer Seperti Mobile Legends, Weekly Diamond Pass, PUBG Mobile, Valorant, Dragon Nest 2, Metal Slug, Fc Mobile, Zepeto, Super Sus, State Of Survival, Clash Of Clans, Brawl Starts, Free Fire, Garena Undawn, Ragnarok Origin, Genshin Impact, Seal M Sea, Ace Racer, Tower Of Fantasy, Wild Rift, Arena Of Valor, Call Of Duty Mobile, Sausage Man Dan Berbagai Game Lainnya Yang Tidak Kalah Seru Untuk Kamu Mainkan.</p>
            </div>
